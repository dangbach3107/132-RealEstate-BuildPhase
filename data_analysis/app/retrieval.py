...
from app.config import AppConfig, ProjectConfig
from app.text import compact_spaces, text_key
from app.valuation import load_market_frame, price_snapshot_references
...
def _nearest_projects(
    ...
    projects = [config.project_by_slug[project_slug]] if project_slug and project_slug in config.project_by_slug else config.projects
