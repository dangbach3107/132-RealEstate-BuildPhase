...
from app.config import AppConfig, get_nested
from app.database import DEFAULT_DB_PATH
from app.normalization import infer_project_slug
from app.schemas import ComparableListing, PriceSnapshotReference, PropertyInput, ValuationResponse
from app.storage import load_market_frame as storage_load_market_frame, load_price_snapshot_frame as storage_load_price_snapshot_frame
from app.text import text_key


def load_market_frame(db_path: str | Path = DEFAULT_DB_PATH) -> pd.DataFrame:
    return storage_load_market_frame(db_path)
